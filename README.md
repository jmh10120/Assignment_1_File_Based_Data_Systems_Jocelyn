...
The dataset contains an "explicit" column that categorises each track as explicit (True) or non-explicit (False), as well as a numerical "popularity" column. This allows the tracks to be grouped based on whether they are explicit and their average popularity scores to be compared.
